...
interface FigmaFlowRateChartsProps {
...
const FigmaFlowRateCharts: React.FC<FigmaFlowRateChartsProps> = ({ chartData, hierarchyChartData }) => {
...
export default FigmaFlowRateCharts;